...
class PlayerPlatformer {
    ...
    handleKeyDown(e) { this.pressedKeys[e.key] = true; }
    handleKeyUp(e) { this.pressedKeys[e.key] = false; }
    update() {
        // Controls
        ...
        const anim = this.animations?.[this.currentAnim]?.[this.direction];
        if (anim) {
...
window.PlayerPlatformer = PlayerPlatformer;
